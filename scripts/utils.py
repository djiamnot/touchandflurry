...
positions = [
    ...
    [0.0510, 0.3431, 6.1517],
    [0.1626, 0.2892, -0.0466],
    [0.0000, 0.0000, 10.3218],
    ...
    [0.5657, -8.4630, 0.2349],
    [-1.5441, 9.6195, -0.1135],
    [0.7359, 10.1853, -0.1009],
    [0.5445, -9.4924, -0.0602],
